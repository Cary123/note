...
# python .\huaban.py -a "getBoard" --board_id "33415555"
# python .\huaban.py -a "getBoard" --board_id "24260264"
# python .\huaban.py -a "getBoard" --board_id "38457458"
# python .\huaban.py -a "getBoard" --board_id "16107836"

# cosplay
# python .\huaban.py -a "getBoard" --board_id "13198748"
# python .\huaban.py -a "getBoard" --board_id "18745902"
